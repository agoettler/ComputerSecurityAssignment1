...
# encrypts with whitespace retained
...
# encrypts and removes whitespace
def completePermutationEncrypt(key, inputFileName, outputFileName):
	...
	# perform encryption on the processed input text
...
# performs the actual encryption; retains whitespace if present
